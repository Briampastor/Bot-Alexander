...
global.bucin = [
  ...
  "No busco a alguien que sea perfecto, pero busco a alguien que sea perfecto gracias a mi superioridad.",
  "El novio de alguien es nuestro alma gemela pendiente.",
  "Los solteros deben pasar. Todos tienen un momento en el que toda soledad se convierte en unión con su amante halal. Se paciente.",
  "Romeo está dispuesto a morir por Julieta, Jack muere por salvar a Rose. El punto es que, si aún quieres vivir, sé soltero.",
  "Busco personas no por sus fortalezas pero busco personas por su sinceridad.",
  "Mate no es un flip flop, que se intercambia con frecuencia. Así que sigue en la lucha correcta.",
