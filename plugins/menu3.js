...
%readmore`
    ...
    conn.reply(m.chat, '*Lo siento, el menú ah dado un error*', m)
    throw e
  }
}
handler.help = ['menu','help','?','Arrowbot']
handler.tags = ['main']
handler.command = /^(menu|help|Inicio|Arrowbot\?)$/i
handler.owner = false
handler.mods = false
